...
//
// Replicates Table 3 from reference [33]: Prices of American Put Options
...
int main() {
    ...
    // True prices from reference [33] Table 3
    // True values are based on a binomial tree with 15000 time-steps using Black & Scholes at the last time-step
    const TableRow rows[] = {
        // T = 0.5, σ = 0.2
        ...
        // T = 3, σ = 0.2
        {3.0, 0.2, 80.0, 23.22837},
        {3.0, 0.2, 100.0, 12.60529},
        {3.0, 0.2, 120.0, 6.48247},
    ...
    // Print table header
    std::cout << "Table 3 – Prices of American Put Options (K = 100, δ = 0.04, r = 0.04)\n";
